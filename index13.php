...
<html>
<head>
    <title>Tutorial 13 - Rendering Multiple Models (Objects) Separately</title>
    ...
    <script type = "text/javascript">
        ...
        window.webGLResourcesLoaded = function() {
            ...
            gl.useProgram( Shader.moveProgram );
            ...
            var T = setInterval(function() {
                ...
                gl.uniform1i(gl.getUniformLocation(Shader.moveProgram, 'image'), 0);
                ...
                gl.uniformMatrix4fv(gl.getUniformLocation(Shader.moveProgram, "Projection"), false, Projection.getAsFloat32Array());
                ...
                for (var xx = 0; xx < 5; xx++) {
                    for (var yy = 0; yy < 5; yy++) {
                        ...
                        gl.uniformMatrix4fv(
                            gl.getUniformLocation(Shader.moveProgram, "Model"), false,
                            Model.getAsFloat32Array());

                        gl.uniformMatrix4fv(
                            gl.getUniformLocation(Shader.moveProgram, "View"), false,
