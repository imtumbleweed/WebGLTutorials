        ...
        if (xmlhttp.readyState == XMLHttpRequest.DONE) {
            ...
            if (xmlhttp.status == 200) {
                ...
                for (var i = 0; i < lines.length; i++)
                {
                    ...
                    console.log("END_HEADER for " + filename);
                ...
                // Load this model into next model array and increment count
                window.ref_arrayMDL[window.current_Model_ID] = new Array();

                window.ref_arrayMDL[window.current_Model_ID++] = [
