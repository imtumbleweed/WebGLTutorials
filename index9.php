...
<html>
<head>
    <title>Tutorial 9 - WebGL Matrix Operations</title>
    ...
    <script type = "text/javascript">
        ...
        window.webGLResourcesLoaded = function() {
            ...
            var mat4Perspective = new CanvasMatrix4();
            var mat4Matrix = new CanvasMatrix4();
            ...
            var T = setInterval(function() {
                ...
                mat4Perspective.lookat(0,0,20, 0, 0, 0, 0, 1, 0);
                mat4Perspective.perspective(45, width / height, 0.05, 1000);
                gl.uniformMatrix4fv(gl.getUniformLocation(Shader.textureProgram, "Perspective"), false, mat4Perspective.getAsCanvasFloatArray());
                ...
                var angle = 0;
                var scale = 1.0;
                mat4Matrix.scale(scale, scale, scale);
                mat4Matrix.rotate(angle, 0, 1, 0);
                mat4Matrix.translate(x, y, z);
                gl.uniformMatrix4fv(gl.getUniformLocation(Shader.textureProgram, "ModelView"), false, mat4matrix.getAsCanvasFloatArray());
